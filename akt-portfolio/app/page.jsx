        ...
        <div className="flex flex-col xl:flex-row items-center justify-between xl:pt-8 xl:pb-24">
          <div className="text-center xl:text-left order-2 xl:order-none mt-5">
            ...
            <h1 className="h2 mt-6 mb-6">
              Hello! I'm <br />{" "}
              <span className="text-amber-400">Abdulkadir TARTILACI</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">
              I am a Software Developer and working mainly on frontend. I love
              design!
            </p>
            <div className="flex flex-col xl:flex-row items-center gap-8">
              <div className="mb-8 xl:mb-0">
                <Social
                  ...
                  iconStyles="w-9 h-9 border border-white rounded-full flex justify-center items-center text-amber-300 text-base hover:bg-amber-300 hover:text-primary hover:transition-all duration:500"
                />
              </div>
            </div>
          </div>
